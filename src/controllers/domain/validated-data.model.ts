 ...
 * @remark This class is intended to be extended by classes that define the data structure for a controller method.
 * @remark These are used similarly to common usage for DTOs, but in compliance with principle of DTOs only being
