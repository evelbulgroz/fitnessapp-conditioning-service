 ...
 * };
 */
type DomainPathExtractor = (manager: DomainStateManager, appRootName?: string) => string;
 ...
 */
const filePathExtractor: DomainPathExtractor = (manager: DomainStateManager, appRootName: string = 'app'): string => {
