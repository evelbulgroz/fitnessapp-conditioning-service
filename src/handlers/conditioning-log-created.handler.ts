 ...
 */
@Injectable()
export class ConditioningLogCreatedHandler extends DomainEventHandler<ConditioningLogLogCreatedEvent> {
	constructor(
	...
	public async handle(event: ConditioningLogLogCreatedEvent): Promise<void> {
