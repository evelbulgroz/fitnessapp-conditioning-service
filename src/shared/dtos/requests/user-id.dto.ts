 ...
 * @remark Ignore the private '_userId' property autogenerated by the @IsDefined() decorator:
 *  only ever access the value via the 'userId' or 'value' properties, which point to the same value.
 * 
