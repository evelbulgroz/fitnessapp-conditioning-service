 ...
 * @remark Ignore the private '_logId' property autogenerated by the @IsDefined() decorator:
 *  only ever access the value via the 'logId' or 'value' properties, which point to the same value.
 * 
